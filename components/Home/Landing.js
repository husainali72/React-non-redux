...
const cardContents = [
						{	img: "card_2.jpg",
							...
							description: "Start investing in crypto and blockchain assets using our intuitive research tools. By using our insightful events and calculated diversification techniques, you’ll receive a competitive edge in the crypto investing and education space.",
							link: "tool-two"},
						{	img: "card_3.jpg",
...
// }
	...
	<div id="landing" className="section">
			...
			<Col md={8} className="col-md-offset-2">
				<h5>A platform that offers events and automated execution for cryptocurrency and blockchain assets as well as complexity-free and investor-friendly index funds.</h5>
			</Col>
